		...
		<div class="CustMgtWrap">
			<form>
				...
				<table>
					<tr>
						<td>거래처명*</td>
						<td><input class="custInput cs" type="text" name="cust_name" value=""></td>
						<td>구분</td>
						<td><input class="custInput cs" type="text" name="cust_cla" value=""></td>
					</tr>
					<tr>
						<td>사업자등록번호</td>
						<td><input class="custInput cs" type="text" name="cust_bizcode" value=""></td>
						<td>대표자명</td>
						<td><input class="custInput cs" type="text" name="cust_ceo" value=""></td>
					</tr>
					<tr>
						<td>업종</td>
						<td><input class="custInput cs" type="text" name="cust_ind" value=""></td>
						<td>종목</td>
						<td><input class="custInput cs" type="text" name="cust_stk" value=""></td>
					</tr>
					<tr>
						<td>우편번호1</td>
						<td colspan="3"><input class="custInput postInput cs" type="text" name="cust_post1" value=""><input class="findPost1" type="button" value="우편번호찾기"></td>
					</tr>
					<tr>
						<td>주소1</td>
						<td colspan="3"><input class="custInput addrInput cs" type="text" name="cust_addr1" value=""></td>
					</tr>
							<tr>
						<td>우편번호2</td>
						<td colspan="3"><input class="custInput postInput cs" type="text" name="cust_post2" value=""><input class="findPost2" type="button" value="우편번호찾기"></td>
					</tr>
					<tr>
						<td>주소2</td>
						<td colspan="3"><input class="custInput addrInput cs" type="text" name="cust_addr2" value=""></td>
					</tr>
					<tr>
						<td>연락처</td>
						<td><input class="custInput cs" type="text" name="cust_tel" value=""></td>
						<td>휴대전화</td>
						<td><input class="custInput cs" type="text" name="cust_phone" value=""></td>
					</tr>
					<tr>
						<td>팩스</td>
						<td><input class="custInput cs" type="text" name="cust_fax" value=""></td>
						<td>이메일</td>
						<td><input class="custInput cs" type="text" name="cust_email" value=""></td>
					</tr>
					<tr>
						<td>계좌번호</td>
						<td colspan="3"><input class="custInput addrInput cs" type="text" name="cust_account" value="" placeholder="은행명 예금주 계좌번호"></td>

					</tr>
					<tr>
						<td>메모</td>
						<td colspan="3"><textarea class="cs" name="cust_memo" rows="6" cols="50"></textarea></td>
					</tr>
					<tr>
						<td colspan="4"><input class="custInputBtn" type="button" name="insertSub" value="생성"><input class="custInputBtn custInsertCancel" type="button" value="취소"></td>
					</tr>
				</table>
				</div>
			</form>
